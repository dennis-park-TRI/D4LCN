...
DOCKER_OPTS = \
	...
	--network=host \
	--privileged \
	-e DETECTRON2_DATASETS=/mnt/fsx/datasets/ \
	-e PYTHONPATH=/workspace/:/workspace/ouroboros/:/workspace/packnet-sfm:/workspace/ouroboros-evaluate/ \
...
docker-dev:
	...
	$(DOCKER_OPTS) \
	-v $(PWD):$(WORKSPACE) \
	-v $(PWD)/../ouroboros:$(WORKSPACE)/../ouroboros \
	-v $(PWD)/../ouroboros-evaluate:$(WORKSPACE)/../ouroboros-evaluate \
	$(DOCKER_IMAGE) bash
