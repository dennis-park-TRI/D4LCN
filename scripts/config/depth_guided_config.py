...
def Config():
    ...
    # (dennis.park) Raw data lives here: s3://tri-ml-datasets/KITTI3D/
    conf.KITTI3D_ROOT = "/mnt/fsx/datasets/KITTI3D"
    # Download and extract: https://drive.google.com/file/d/1lSJpQ8GUCxRNtWxo0lduYAbWkkXQa2cb/view
    conf.DORN_KITTI_DEPTH_DIR = "/mnt/fsx/kitti_dorn_depth/"
